...
echo "<script>var div2=document.getElementById('hijo2');
console.log(div2.style);</script>";
?>
<div class="luisito20" id=luisito20> <header>
    <div id=hijo1>
<body >
        ...
        <section class="estudios">
            ...
            <ul>
                <li>
                    ...
                    <?php
                    if(isset($row['tutulo2']) && $row['tutulo2']!=""){echo "<li><h3>".$row['tutulo2']."</h3>";?> 
...
<div>
<button onclick="generarPDF();">Imprimir</button></div>
